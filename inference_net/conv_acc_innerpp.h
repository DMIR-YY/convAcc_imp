...
#pragma HLS UNROLL
                                if(i==0&&j==0&&tn==0&&n==0) 
                                    out_buf[tm][tr][tc] = b_buf[tm] + w_buf[tn][tm][i][j] * in_buf[tn][S*(tr)+i + r_offset][S*(tc)+j + c_offset];
                                else
                                    out_buf[tm][tr][tc] = out_buf[tm][tr][tc] + w_buf[tn][tm][i][j] * in_buf[tn][S*(tr) + i + r_offset][S*(tc)+j + c_offset];
                            }
                        }
                    }
                }
